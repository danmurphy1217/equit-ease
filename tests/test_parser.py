...
class TestParserMethods(unittest.TestCase):
    ...
    def test_extract_data_from_pass(self):
        ...
        extracted_data_one = self.parser._extract_data_from(self.data_fixture, 'invalid_key')
        ...
        self.assertEqual(extracted_data_one, "N/A") # returns N/A for keys that don't exist in the data struct
    ...
    def test_extract_data_from_pass_empty(self):
        ...
        extracted_data_one = self.parser._extract_data_from(self.data_fixture, 'invalid_key')
        extracted_data_two = self.parser._extract_data_from(self.data_fixture, 'another_invalid_key')
    ...
    def test_build_dict_repr_pass(self):
        ...
        dict_repr_one = self.parser._build_dict_repr(keys_to_extract_one, self.data_fixture)
        dict_repr_two = self.parser._build_dict_repr(keys_to_extract_two, self.data_fixture)
        dict_repr_three = self.parser._build_dict_repr(keys_to_extract_three, self.data_fixture)
