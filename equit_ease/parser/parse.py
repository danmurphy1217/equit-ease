...
class Parser(Reader):
    ...
    def extract_equity_meta_data(self):
        ...
        def extract_data_from(
            equity_metadata: Dict[str, Any], key_to_extract: str
        ) -> str or int:
            """
        ...
        for key in list(keys_to_extract):
            equity_meta_mappings[key] = extract_data_from(
                equity_metadata["quoteResponse"]["result"][0], key
            )
