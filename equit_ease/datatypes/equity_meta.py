...
class EquityMeta:
    ...
    fifty_two_wk_range: Tuple[float, float] # low - high price for the stock [last year]
    volume_stats: Dict[str, float] # intra_day volume, monthly avg. volume, and ten_day avg. volume
